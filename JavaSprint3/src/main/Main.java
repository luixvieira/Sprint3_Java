...
import java.sql.Connection; // Importa a classe de serviço para gerenciar prontuários
import java.sql.Statement;   // Importa a classe de serviço para gerenciar mecânicos
import java.util.Scanner;   // Importa a classe de serviço para gerenciar filiados
import model.Filiados;            // Importa a classe que gerencia a conexão com o banco de dados
import model.Prontuario;          // Importa o modelo da entidade Prontuario
import service.FiliadosService;            // Importa o modelo da entidade Filiados
import service.MecanicoService;       // Importa a classe Connection para a conexão com o banco de dados
import service.ProntuarioService;        // Importa a classe Statement para executar comandos SQL
import util.ConexaoDB;         // Importa a classe Scanner para ler a entrada do usuário
